...
public class ProductController {
    ...
    public String updateProduct(
        ...
        try {
            Product product = repo.findById(id).get();
            ((Object) model).addAttributse("product", product);
    ...
    public CategoryRepository getRepo2() {
        return repo2;
    }

    public void setRepo2(CategoryRepository repo2) {
        this.repo2 = repo2;
    }

    public MarkRepository getRepo3() {
        return repo3;
    }

    public void setRepo3(MarkRepository repo3) {
        this.repo3 = repo3;
    }
}
